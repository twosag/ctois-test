...
exports.main = exports.uabsMenu = exports.medMenu = exports.sumduMenu = exports.institutionsMenu = exports.problemMenu = void 0;
const grammy_1 = require("grammy");
const menu_1 = require("@grammyjs/menu");
exports.problemMenu = new grammy_1.InlineKeyboard([
    [{ text: 'Інтернет підключення ddf ', callback_data: 'wifi_problem' }],
...
exports.main = new menu_1.Menu("root-menu")
    .text("Інтернет підключення", (ctx) => ctx.reply("Ви обрали: Інтернет підключення"))
    .text("Інтернет підключення2", (ctx) => ctx.reply("Ви обрали: Інтернет підключення2"))
    .text("Інтернет підключення3", (ctx) => ctx.reply("Ви обрали: Інтернет підключення3"))
    .text("Інтернет підключення4", (ctx) => ctx.reply("Ви обрали: Інтернет підключення4"))
