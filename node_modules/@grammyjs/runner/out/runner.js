...
function run(bot, concurrency = 500, sourceOptions = {}, runnerOptions = {}, sinkOptions = {
    ...
    // create source
    const source = (0, source_js_1.createSource)({
    ...
    // create sink
    const sink = (0, sink_js_1.createConcurrentSink)({ consume: (update) => bot.handleUpdate(update) }, async (error) => {
        try {
...
async function throwIfUnrecoverable(err) {
    ...
    if (code === 429) {
        ...
        const delay = (_a = err.parameters) === null || _a === void 0 ? void 0 : _a.retry_after;
